...
export const CreateToken: FC = () => {
  ...
  const initializeBundlr = async () => {
    ...
    // if (selected.name === "https://node1.bundlr.network") {
    //   bundler = new WebBundlr(`${selected.name}`, "solana", provider, {
    //     providerUrl: "https://node1.bundlr.network",
    //   });
    // } else {
    //   bundler = new WebBundlr(`${selected.name}`, "solana", provider);
    // }
    // selected.name = "https://node1.bundlr.network";
    bundler = new WebBundlr("https://node1.bundlr.network", "solana", provider);
